...
export function FarmerProfile({ userData, language }: FarmerProfileProps) {
  return (
    <div>
      <h2 className="text-gray-800 mb-6">My Profile</h2>
        ...
        <div className="bg-gradient-to-r from-green-600 to-green-700 p-8 text-white">
          <div className="flex items-center gap-6">
            ...
            <div className="flex-1">
              <h3 className="text-white mb-2">{userData.name}</h3>
              <div className="text-white/80 text-sm mb-3">MRID: {userData.mrid}</div>
              <Badge className="bg-white/20 text-white hover:bg-white/30">Verified Farmer</Badge>
            </div>
          </div>
        </div>
      ...
      <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-2xl shadow-md p-6">
        <h3 className="text-green-800 mb-3">Account Statistics</h3>
        <div className="grid grid-cols-2 gap-4">
          <div className="bg-white rounded-xl p-4">
            <div className="text-gray-500 text-sm mb-1">Total Harvests</div>
            <div className="text-2xl text-gray-800">{userData.harvests?.length || 0}</div>
          </div>
          <div className="bg-white rounded-xl p-4">
